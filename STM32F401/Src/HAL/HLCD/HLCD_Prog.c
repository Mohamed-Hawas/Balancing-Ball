...
/*-----------------------------------------------------------------------------------------------------*/
#include "../../../Src/HAL/HLCD/HLCD_Config.h"                 // Include the LCD configuration header file.
#include "../../../Src/HAL/HLCD/HLCD_Int.h"                    // Include the LCD interface header file.
#include "../../../Src/HAL/HLCD/HLCD_Int.h"					 // Include the LCD Interface file.
